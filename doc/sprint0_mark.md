...
**Github:** https://github.com/UTSCCSCC01/finalprojects22-justontime  
...
## competition.md (Max 2 marks)
  ...
  Comments: Ticketmaster also has bidding for tickets, although, it's not geared for last minute purchases. 
...
## Process: process.md (max 10 marks)
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Comments: Planning poker is usually used for estimating the effort required to complete a task and not to prioritize a task. The user story's effort and priority are not always correlated. For example, creating a landing page might be low effort but high in priority and creating a recommendation system might be high effort but low in priority.
...
## User experience: (max 4 marks)
  ...
  - Graphic representation is clear and represents well indended user interface elements (max 2 marks)
    ...
    Feedback: UI representation needs more detail. These are supposed to be rough sketches but these lack too much detail.  
