...
## Planning Meetings (RPM.md, sprintN.md) (max 5 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    - 0 marks = No meeting document submitted or the submitted document contains no relevant information to the sprint 1
      ...
      Your Mark: 1 missing "tasks breakdown is done" portion
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 16 / 20
  Note: You did have a lot of sub-tasks but it looks like a large user story was removed from the sprint and no explanation was provided
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 3 missing Parent & Child classes for every CRC
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 4 - diagram can still be improved; remember the server and db are run on different processes and usually are represented in two different components.
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 8 marks)
    ...
    6
    No proper home page setup, No error Handling for Login/Sign up form, very large fields for the form
  ...
  - Presentation (max 2 marks)
    ...
    1 
    UI can be improved in terms of the background and color scheme used
...
Notes: you guys are missing out on small details, make sure to read the rubric carefully next time
